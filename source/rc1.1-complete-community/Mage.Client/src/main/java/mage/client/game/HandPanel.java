...
public class HandPanel extends JPanel {
    ...
    private Dimension getCommunityHandCardDimension() {
        ...
        return new Dimension(
                Math.max(base.width, (int) Math.round(base.width * XCP_HAND_SCALE)),
                Math.max(base.height, (int) Math.round(base.height * XCP_HAND_SCALE))
        );
    }
    // XCP_HAND_SCALE_V3_V4_END
    ...
    public void initComponents() {
        ...
        hand.setCardDimension(getCommunityHandCardDimension());
    ...
    private void setGUISize() {
        ...
        jScrollPane1.getHorizontalScrollBar().setUnitIncrement(GUISizeHelper.getCardsScrollbarUnitInc(getCommunityHandCardDimension().width));
        hand.setCardDimension(getCommunityHandCardDimension());
        hand.changeGUISize();
    }
