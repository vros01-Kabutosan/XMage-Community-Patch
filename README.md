...
Esta base contiene la fuente completa y los recursos necesarios para el reactor
Maven. No contiene el indicador T. El documento [SOURCE-OF-TRUTH.md](SOURCE-OF-TRUTH.md)
...
Cuando una candidata supera todos los controles y es aceptada, su fuente
completa pasa a ser la siguiente base canónica. La base anterior queda como
recuperación de emergencia. Solo existe una candidata activa.
...
XMage es un proyecto de la comunidad Magefree. Este repositorio es una
distribución comunitaria independiente. Consulta los avisos y licencias incluidos
