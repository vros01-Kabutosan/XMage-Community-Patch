...
setlocal
cd /d "%~dp0"
title XMage Community Patch - V4 UX FINAL R5 (FIXED)

echo ================================================================
echo XMage Community Patch - V4 UX FINAL R5 (FIXED)
echo ================================================================
echo.
...
where py >nul 2>nul
if %errorlevel%==0 (
    py -3 "%~dp0xmage_v4_ux_final_r5_FIXED.py"
) else (
    python "%~dp0xmage_v4_ux_final_r5_FIXED.py"
)
