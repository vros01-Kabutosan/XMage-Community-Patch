...
title XMage RC1.3 - Trigger Visual Smoke FINAL
...
set "STAMP=%STAMP: =0%"
set "LOG_DIR=%LOG_ROOT%\smoke_visual_RC1.3_FINAL_%STAMP%"
set "SMOKE_ROOT=J:\mtg\_SMOKE\RC1.3-trigger-FINAL_%STAMP%"
